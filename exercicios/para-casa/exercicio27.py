...
quantidade_da_fruta = float(input("Muito bem! Agora nos indique, por favor, a quantidade que deseja comprar. (Por favor, note que o nosso sistema calculará a quantidade em KG): "))
...
if tipo_da_fruta == "1" and quantidade_da_fruta < 5:
    ...
    print ("O valor da sua compra de " + str(quantidade_da_fruta) + " kilos de morangos será de R$ " + str(preco_total_mor))    

 #Se for mais que 5kg
elif tipo_da_fruta == "1" and quantidade_da_fruta > 5:
    preco_bruto_mor_maior5 = (quantidade_da_fruta * preco_morango_maiorque5)
    print(preco_bruto_mor_maior5)
...
if tipo_da_fruta == "2" and quantidade_da_fruta < 5:
    ...
    print ("O valor da sua compra de " + str(quantidade_da_fruta) + " kilos de morangos será de R$ " + str(preco_total_mac))    
